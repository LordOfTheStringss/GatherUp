...
export class UserManager {
    ...
    public async updateProfile(userId: string, data: { name?: string, bio?: string, interests?: string[], profilePhoto?: string, baseLocation?: string, currentStatus?: string }): Promise<void> {
        ...
        if (data.currentStatus) updateData.current_status = data.currentStatus;
